...
#include "std_msgs/String.h"
 ...
 void imuCallback(const std_msgs::String::ConstPtr& msg)  //This is the callback function that will get
 ...
 int main(int argc, char **argv)
 {
   ...
   ros::Subscriber sub = n.subscribe("/quadrotor_1/imu", 1, imuCallback); //Subscribe to the __ topic with the master. ROS will
